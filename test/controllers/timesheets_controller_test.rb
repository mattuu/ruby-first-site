...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post timesheets_url, params: { timesheet: { endDate: @timesheet.endDate, name: @timesheet.name, startDate: @timesheet.startDate } }
    end
  ...
  test "should update timesheet" do
    patch timesheet_url(@timesheet), params: { timesheet: { endDate: @timesheet.endDate, name: @timesheet.name, startDate: @timesheet.startDate } }
